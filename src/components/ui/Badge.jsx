const statusColors = {
  'New': 'bg-blue-100 text-[#0082f3] dark:bg-blue-900/40 dark:text-blue-300',
  ...
  'Negotiation': 'bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-200',
  ...
  'Rescheduled': 'bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-200',
  'Completed': 'bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300',
  'Cancelled': 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300',
  'Residential': 'bg-blue-100 text-[#0082f3] dark:bg-blue-900/40 dark:text-blue-300',
