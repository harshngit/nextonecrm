...
export default function SiteVisitLeads() {
  ...
  const [filterStatus] = useState('site_visit_done')
  ...
  // Status isn't included — this page is always scoped to 'site_visit_done'.
  ...
  const handleExport = async (dateRange) => {
    try {
      ...
      if (filterStatus) params.status = filterStatus // always 'site_visit_done' on this page
      ...
      const a = document.createElement('a'); a.href = url; a.download = `SiteVisitDoneLeads_${dateRange.from}_to_${dateRange.to}.xlsx`
