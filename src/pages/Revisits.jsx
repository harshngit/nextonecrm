  ...
  return (
    <Modal isOpen onClose={onClose} title="Schedule Re-visit" size="md">
      <form onSubmit={handleSubmit} className="space-y-4">
        <CustomSelect label="Original Site Visit *" value={form.original_visit_id}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input type="time" required value={form.visit_time}
              onChange={e => setForm(p => ({ ...p, visit_time: e.target.value }))} className={ic} />
          </div>
        </div>
